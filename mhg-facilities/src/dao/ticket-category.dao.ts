...
type TicketCategoryUpdate =
  Database["public"]["Tables"]["ticket_categories"]["Update"];
...
export class TicketCategoryDAO extends BaseDAO<"ticket_categories"> {
   ...
   */
  async findByIdWithDefaults(
    id: string,
  ): Promise<TicketCategoryWithDefaults | null> {
    const { supabase, tenantId } = await this.getClient();
  ...
  async findByPriority(
    priority: Database["public"]["Tables"]["ticket_categories"]["Row"]["default_priority"],
  ...
  async createCategory(
    data: Omit<TicketCategoryInsert, "tenant_id" | "created_at" | "deleted_at">,
  ): Promise<TicketCategory> {
  ...
  async updateCategory(
    id: string,
    data: Partial<TicketCategoryUpdate>,
  ): Promise<TicketCategory> {
