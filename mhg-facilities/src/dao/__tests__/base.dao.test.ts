...
describe("BaseDAO", () => {
  ...
  describe("Tenant Isolation", () => {
    ...
    it("should include tenant_id in update queries", async () => {
      ...
      await dao.update("test-id", { email: "updated@test.com" } as Parameters<
        typeof dao.update
      >[1]);
  ...
  describe("Soft Delete", () => {
    ...
    it("should not allow updates to soft-deleted records", async () => {
      ...
      await dao.update("test-id", { email: "test@test.com" } as Parameters<
        typeof dao.update
      >[1]);
  ...
  describe("CRUD Operations", () => {
    it("should create record with tenant_id", async () => {
      ...
      const result = await dao.create({ email: "test@test.com" } as Parameters<
        typeof dao.create
      >[0]);
    ...
    it("should throw error for other database errors", async () => {
      ...
      await expect(dao.findById("test-id")).rejects.toThrow(
  ...
  describe("Error Handling", () => {
    ...
    it("should throw error on create failure", async () => {
      ...
      await expect(
        dao.create({ email: "test@test.com" } as Parameters<
          typeof dao.create
        >[0]),
    ...
    it("should throw error on update failure", async () => {
      ...
      await expect(
        dao.update("test-id", { email: "test@test.com" } as Parameters<
          typeof dao.update
        >[1]),
