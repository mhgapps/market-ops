...
export class PMTemplateService {
  constructor(private templateDAO = new PMTemplateDAO()) {}
  ...
  async updateTemplate(
    ...
    if (data.default_vendor_id !== undefined)
      updateData.default_vendor_id = data.default_vendor_id;
