...
export class VendorRatingService {
   ...
   */
  async createRating(
    data: CreateVendorRatingDTO,
  ): Promise<VendorRatingWithRelations> {
  ...
  async compareVendors(
    ...
    return {
      ...
      better_response:
        vendor1Stats && vendor2Stats
          ? vendor1Stats.average_response_time >
            vendor2Stats.average_response_time
            ? "vendor1"
            : "vendor2"
          : null,
      better_quality:
