...
import { createVendorSchema, type CreateVendorInput } from '@/lib/validations/assets-vendors'
...
export const VendorForm = forwardRef<VendorFormHandle, VendorFormProps>(function VendorForm({
  defaultValues,
  onSubmit,
}, ref) {
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem className="flex items-center space-x-2">
                          ...
                          <FormLabel htmlFor="is_preferred" className="!mt-0 cursor-pointer">
                            Preferred Vendor
                          </FormLabel>
                        </FormItem>
                      )}
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem className="flex items-center space-x-2">
                          ...
                          <FormLabel htmlFor="is_active" className="!mt-0 cursor-pointer">
                            Active
                          </FormLabel>
                        </FormItem>
                      )}
