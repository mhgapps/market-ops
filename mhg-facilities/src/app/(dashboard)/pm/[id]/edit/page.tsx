...
export default function EditPMSchedulePage() {
  ...
  const { data: schedule, isLoading: scheduleLoading } = usePMSchedule(scheduleId)
  ...
  const isLoading = scheduleLoading || assetsLoading || templatesLoading || locationsLoading || vendorsLoading || usersLoading
