...
-- Create asset types (specific equipment under each category)
INSERT INTO asset_types (id, tenant_id, category_id, name, description)
VALUES
  ('21000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001', '20000000-0000-0000-0000-000000000001', 'Compressor', 'HVAC compressor'),
  ('21000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000001', '20000000-0000-0000-0000-000000000001', 'Air Handler', 'Air handling unit'),
  ('21000000-0000-0000-0000-000000000003', '00000000-0000-0000-0000-000000000001', '20000000-0000-0000-0000-000000000001', 'Rooftop Unit', 'Packaged rooftop HVAC unit'),
  ('21000000-0000-0000-0000-000000000004', '00000000-0000-0000-0000-000000000001', '20000000-0000-0000-0000-000000000002', 'Walk-in Cooler', 'Commercial walk-in cooler'),
  ('21000000-0000-0000-0000-000000000005', '00000000-0000-0000-0000-000000000001', '20000000-0000-0000-0000-000000000002', 'Reach-in Refrigerator', 'Commercial reach-in refrigerator'),
  ('21000000-0000-0000-0000-000000000006', '00000000-0000-0000-0000-000000000001', '20000000-0000-0000-0000-000000000002', 'Ice Machine', 'Commercial ice machine'),
  ('21000000-0000-0000-0000-000000000007', '00000000-0000-0000-0000-000000000001', '20000000-0000-0000-0000-000000000003', 'Stove', 'Commercial stove/range'),
  ('21000000-0000-0000-0000-000000000008', '00000000-0000-0000-0000-000000000001', '20000000-0000-0000-0000-000000000003', 'Grill', 'Flat-top or char grill'),
  ('21000000-0000-0000-0000-000000000009', '00000000-0000-0000-0000-000000000001', '20000000-0000-0000-0000-000000000003', 'Deep Fryer', 'Commercial deep fryer'),
  ('21000000-0000-0000-0000-000000000010', '00000000-0000-0000-0000-000000000001', '20000000-0000-0000-0000-000000000004', 'POS Terminal', 'Point-of-sale terminal'),
  ('21000000-0000-0000-0000-000000000011', '00000000-0000-0000-0000-000000000001', '20000000-0000-0000-0000-000000000004', 'Receipt Printer', 'Thermal receipt printer'),
  ('21000000-0000-0000-0000-000000000012', '00000000-0000-0000-0000-000000000001', '20000000-0000-0000-0000-000000000005', 'Water Heater', 'Commercial water heater'),
  ('21000000-0000-0000-0000-000000000013', '00000000-0000-0000-0000-000000000001', '20000000-0000-0000-0000-000000000005', 'Booster Pump', 'Water pressure booster pump'),
  ('21000000-0000-0000-0000-000000000014', '00000000-0000-0000-0000-000000000001', '20000000-0000-0000-0000-000000000006', 'Fire Extinguisher', 'Portable extinguisher'),
  ('21000000-0000-0000-0000-000000000015', '00000000-0000-0000-0000-000000000001', '20000000-0000-0000-0000-000000000006', 'Fire Alarm Panel', 'Fire alarm control panel');
